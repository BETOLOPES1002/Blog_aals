...
<body>
  	   ...
  	   <main class="main-blog">
  	   	...
  	   	<?php foreach ($posts as $post) { ?>
			  ...
			  <div class="card-body">
			    ...
			    <a href="blog-view.php?post_id=<?=$post['post_id']?>" class="btn btn-primary">Leer Mas</a>
			    <hr>
  	   	...
  	   	<main class="main-blog p-2">
  	   		<?php if($notFound){ ?>
  	   			<div class="alert alert-warning"> 
  	   				Sin resultados,intneta otra cosa 
  ...
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', function() {
      navigator.serviceWorker.register('/Blog/service-worker.js').then(function(registration) {
