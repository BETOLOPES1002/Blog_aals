...
<body>
	...
	?>
	 ...
	 <div class="main-table">
	 	<h3 class="mb-3">Todos los Posts 
	 		<a href="post-add.php" class="btn btn-success">Añadir</a></h3>
	 	...
	 	<table class="table t1 table-bordered">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td>
		      	<a href="post-delete.php?post_id=<?=$post['post_id'] ?>" class="btn btn-danger">Borrar</a>
